...
class MainPageYandexScooter:
    ...
    def receive_text_answer_question_1(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_1).text()
    ...
    def receive_text_answer_question_2(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_2).text()
    ...
    def receive_text_answer_question_3(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_3).text()
    ...
    def receive_text_answer_question_4(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_4).text()
    ...
    def receive_text_answer_question_5(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_5).text()
    ...
    def receive_text_answer_question_6(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_6).text()
    ...
    def receive_text_answer_question_7(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_7).text()
    ...
    def receive_text_answer_question_8(self):
        self.driver.find_element(*MainPageLocators.TEXT_ANSWER_QUESTION_8).text()
