...
class AboutRentPageLocators:
    ...
    TWO_DAYS_VALUE = [By.XPATH, '//div[@class="Dropdown-option" and text()="двое суток"]'] # двое суток
    SIX_DAYS_VALUE = [By.XPATH, '//div[@class="Dropdown-option" and text()="шестеро суток"]']  # шестеро суток
